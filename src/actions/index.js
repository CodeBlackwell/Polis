...
export function getRepWords(rep) {
  return dispatch => {
    return fetch('https://capitolwords.org/api/1/phrases.json?entity_type=legislator&entity_value=' + rep + '&sort=count+desc&apikey=22e19e45eb5e4582891e0d17b73f90c1')
      .then(response => response.json())
